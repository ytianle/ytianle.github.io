...
- **CPU ray tracer using C++** (by Peter Shirley): [https://raytracing.github.io/](https://raytracing.github.io/) 
...
- **GPU ray tracer using Vulkan**: [https://github.com/grigoryoskin/vulkan-compute-ray-tracing](https://github.com/grigoryoskin/vulkan-compute-ray-tracing)
- **GPU ray tracer using OpenGL3.1** (back to my 2021 TAing): [https://github.com/yuantianle/Ray_Tracing-Sep2021](https://github.com/yuantianle/Ray_Tracing-Sep2021)
...
- **CUDA path tracer** (by YINING KARL LI): [https://www.yiningkarlli.com/projects/gpupathtracer.html](https://www.yiningkarlli.com/projects/gpupathtracer.html)
