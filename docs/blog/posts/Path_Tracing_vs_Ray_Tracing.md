...
- **CPU ray tracer using C++** (by Peter Shirley): https://raytracing.github.io/ (I also highly recommend his ray tracing book: [Advanced Global Iluumination](https://www.amazon.com/Advanced-Global-Illumination-Philip-Dutre/dp/1568813074/ref=sr_1_1?crid=XAJB88GF62M5&dib=eyJ2IjoiMSJ9.AhqsNjaAZChvUxfoarCZVA.XxtPvOIUc8DnkfyCx4R5jaGhOe4SgWwUO-u_PznMNpU&dib_tag=se&keywords=peter+shirley+advanced+global+illumination&qid=1746076136&sprefix=peter+shirley+advanced+global+illumination%2Caps%2C138&sr=8-1), which explained the theory of tracing in math-physical formula real nice.)
